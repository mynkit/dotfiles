...
let p = streamReplace tidal
    ...
    d1 = p 1 . (|< orbit 0) . (|< pS "ntag" "unknown")
    d2 = p 2 . (|< orbit 1) . (|< pS "ntag" "unknown")
    d3 = p 3 . (|< orbit 2) . (|< pS "ntag" "unknown")
    d4 = p 4 . (|< orbit 3) . (|< pS "ntag" "unknown")
    d5 = p 5 . (|< orbit 4) . (|< pS "ntag" "unknown")
    d6 = p 6 . (|< orbit 5) . (|< pS "ntag" "unknown")
    d7 = p 7 . (|< orbit 6) . (|< pS "ntag" "unknown")
    d8 = p 8 . (|< orbit 7) . (|< pS "ntag" "unknown")
    d9 = p 9 . (|< orbit 8) . (|< pS "ntag" "unknown")
    d10 = p 10 . (|< orbit 9) . (|< pS "ntag" "unknown")
    d11 = p 11 . (|< orbit 10) . (|< pS "ntag" "unknown")
    d12 = p 12 . (|< orbit 11) . (|< pS "ntag" "unknown")
    d13 = p 13 . (|< orbit 12) . (|< pS "ntag" "unknown")
    d14 = p 14 . (|< orbit 13) . (|< pS "ntag" "unknown")
    d15 = p 15 . (|< orbit 14) . (|< pS "ntag" "unknown")
    d16 = p 16 . (|< orbit 15) . (|< pS "ntag" "unknown")
:}
